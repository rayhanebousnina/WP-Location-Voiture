<?php 
/**
 * The Footer for SKT Fitness Lite
 *
...
<div id="footer" class="footer-type<?php echo $footertype; ?>">   
    ...
    <div class="contact-info">
                	<div class="col-6">
                    	<div class="box">
                        	<?php if(!empty($complete['footer_logo_id']['url'])){   ?>
                    <a class="footer-logo" title="<?php bloginfo('name') ;?>" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php $logo = $complete['footer_logo_id']; echo $logo['url']; ?>" /></a>
                    ...
                    <div class="col-6">
                    	<div class="box footer-social-icons">
                        	<?php 
							if (!empty ($complete['footer_social_icon'])) { $ft2icon = html_entity_decode($complete['footer_social_icon']); $ft2icon = stripslashes($ft2icon);
							?>
