<?php 
/**
 * The Custom Style for SKT Fitness Lite
 *
...
/*-----------------------------COLORS------------------------------------*/
		...
		/*Head Top Bar Color*/
		.head-info-area{background-color: rgba(<?php echo complete_hex2rgb($complete['head_info_color_id']);?>, <?php if(empty($complete['head_info_bg_trans'])){ echo '0'; }else { echo $complete['head_info_bg_trans'];} ?>);}
		...
		<?php } ?>
		<?php } else { ?>
		.header{background:<?php echo $complete['head_color_id']; ?>!important;}
		<?php } ?>
		...
		.slider-main .nivo-caption .slidebtn a{ 
			...
			background: <?php echo $complete['sldbtn_color_id']; ?>;
		}	
		.slider-main .nivo-caption .slidebtn a:hover{color:<?php echo $complete['sldbtn_hvtextcolor_id']; ?>; 
		background: <?php echo $complete['sldbtn_hvcolor_id']; ?>;}
		...
		.skt-builder-wave g{fill: <?php echo $complete['slider_wave_color']; ?>;} 
		...
		.team-member-img::before{background:<?php echo $complete['team_box_color_id']; ?>;}
		.skt-team-box .team-title a{color:<?php echo $complete['team_box_title_id']; ?>;}
		.skt-team-box .team-designation{color:<?php echo $complete['team_box_designation_id']; ?>;}
		

		.bx-viewport ul li{background:<?php echo $complete['testimonialbox_color_id']; ?>;}
		.testimonial-box{ 
		...
		.bxslider li h3, .bx-viewport ul li h2{color:<?php echo $complete['testimonialbox_txt_color']; ?>;}
		.bxslider li p{color:<?php echo $complete['testimonialbox_deg_color']; ?>;}
		.testimonilacontent {color:<?php echo $complete['testimonialbox_cont_color']; ?>;}
		
		.bxslider li{background-color:<?php echo $complete['testimonialbox_color_id']; ?>; }	
		.bx-viewport::before{border-color:<?php echo $complete['testimonialbox_border_color']; ?>;}
		...
		.portfolio-content .portfolio-categ li a{color:<?php echo $complete['gallery_filtertxt_color_id']; ?>;}		
		
		/* Gallery Filter Active Color */
		.portfolio-content .portfolio-categ .active a{color:<?php echo $complete['gallery_activefiltertxt_color_id']; ?>;}	
		.teacher-name{color:<?php echo $complete['gallery_title_color_id']; ?>;}
		.class-time{background:<?php echo $complete['gallery_title_bg_color_id']; ?>;}
		.class-name{color:<?php echo $complete['gallery_timefiltertxt_color_id']; ?>;}
		
		.mega-hover{background-color: rgba(<?php echo complete_hex2rgb($complete['gallery_title_bg_color_id']);?>, 0.7);}
		.mega-hovertitle{color:<?php echo $complete['gallery_title_color_id']; ?>;}
		.slider-shadow{background-color: rgba(<?php echo complete_hex2rgb($complete['slideshadow_color_id']);?>, 0);}
		.slider-main .nivo-caption{background-color: rgba(<?php echo complete_hex2rgb($complete['slidetitleshadow_color_id']);?>, 0.1);}
		...
		#topmenu ul li ul{border-color:<?php echo $complete['menutxt_color_hover']; ?> transparent;}
		...
		#topmenu ul li.appointment-btn a{color:#fff !important; 
				background-image:linear-gradient(<?php echo $complete['menu_quote_color_top']; ?>,<?php echo $complete['menu_quote_color_bottom']; ?>);}}
		#topmenu ul li.appointment-btn a:hover{background-color: <?php echo $complete['menutxt_color_id'] ?>; color: #282828 !important;}
		#topmenu ul li.appointment-btn a::before{border-top: 30px solid <?php echo $complete['menu_quote_color_bottom']; ?>;}
		#topmenu ul li.appointment-btn a::after{border-top: 30px solid <?php echo $complete['menu_quote_color_bottom']; ?>;;}
...
#footer .contact-info{background-color: <?php echo $complete['footer_color_id']; ?>;}
