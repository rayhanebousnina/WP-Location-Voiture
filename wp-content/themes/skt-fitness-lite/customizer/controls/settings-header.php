...
//MENU Top Get A Quote BG COLOR
$wp_customize->add_setting( 'complete[menu_quote_color_top]', array(
	'type' => 'option',
	'default' => '#17d9f6',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_quote_color_top', array(
				'label' => __('Menu Get A Quote Gradient Top Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[menu_quote_color_top]',
			) ) );

//MENU Bottom Get A Quote BG COLOR
$wp_customize->add_setting( 'complete[menu_quote_color_bottom]', array(
	'type' => 'option',
	'default' => '#1b80e9',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menu_quote_color_bottom', array(
				'label' => __('Menu Get A Quote Gradient Bottom Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[menu_quote_color_bottom]',
			) ) );
