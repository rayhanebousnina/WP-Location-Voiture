...
// Slide Image shadow Color
$wp_customize->add_setting( 'complete[slideshadow_color_id]', array(
	'type' => 'option',
	'default' => '#040608',
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'slideshadow_color_id', array(
				'label' => __('Slider Image overlay Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[slideshadow_color_id]',
			) ) );


// Slide Title Background Color
$wp_customize->add_setting( 'complete[slidetitleshadow_color_id]', array(
	'type' => 'option',
	'default' => '#000',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'slidetitleshadow_color_id', array(
				'label' => __('Slide Title Background Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[slidetitleshadow_color_id]',
			) ) );
...
$wp_customize->add_setting( 'complete[sldbtn_color_id]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sldbtn1_color_id', array(
				'label' => __('Slide Background Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[sldbtn1_color_id]',
			) ) );
...
$wp_customize->add_setting( 'complete[slider_wave_color]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'slider_wave_color', array(
				'label' => __('Slide Wave Color','complete'),
				'section' => 'slider_section',
...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_title1]', array(
		'type' => 'option',
		'default'	=> __('<span>Get in Shape & </span>Be Healthy','complete'),
	...
	$wp_customize->add_setting('complete[slide_desc1]', array(
		'type' => 'option',
		'default'	=> __('3D is a powerful approach to non-surgical<br>face and body treatments.','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
