            ...
            <label class="current_edit"><?php esc_attr_e('View', 'complete'); ?> 
                ...
                <?php if(is_404()){ ?><a><?php esc_attr_e('404 Page', 'complete'); ?> <i></i></a><?php } ?>
                    ...
                    <ul>
						...
						?>
                        <?php $catid =''; $categories = get_categories(array('orderby' => 'count','number' => '1'));
							if($categories){
								$catid = $categories[0]->term_id;
							}
						 ?>
                        <?php $tagid =''; $tags = get_tags(array('orderby' => 'count','number' => '1')); if(!empty($tagid)){ 
							if($tags){
								$tagid = $tags[0]->name;} 
							}
						?>
                        ...
                        <li><a href="<?php echo home_url('/?tag=').$tagid; ?>"><?php esc_attr_e('Tag Page', 'complete'); ?></a></li>
<!--                        <li><a href="<?php echo home_url('/?s=the'); ?>"><?php esc_attr_e('Archive Page', 'complete'); ?></a></li>-->
